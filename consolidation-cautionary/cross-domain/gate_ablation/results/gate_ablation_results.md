...
**Two caveats that must travel with the FPR number.** (1) The gate reaches its low FPR mostly by ABSTAINING rather than rejecting — on the negative controls it returns "not-testable (no reproducible k)" on 26/30 (87%), leaving a testable-negative denominator of 4. An FPR quoted against n=30 is the over-generous convention; against the testable n=4 the interval is [0, 0.4899] and is nearly uninformative. Do not quote FPR=0.000 unqualified. (2) The gate is not free in principle: TPR is unchanged at 1.000. Report the point change and its McNemar p-value together; write neither "TPR held" nor a settled percentage cost. Authoritative accounting: results/ablation_honest.json.