...
these data, and the reported R²=0.889 was recorded as an "expected output" — it was not computed
from the data. The pipeline does **not** consume this file (the shipped stability threshold is
